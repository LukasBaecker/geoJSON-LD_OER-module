...
```{r JSONpagePic, echo=FALSE, out.width= "50%", out.extra='style="float:right; padding:10px"'}
...
```
One great tool that can be used to help us writing the GEOJSON is the [geojson.io](https://geojson.io/#map=2/20.0/0.0).
