...
```{r abstractPic, echo=FALSE, out.width= "80%", out.extra='style="margin-left:50%; transform: translate(-50%)"'}
myimg2 <- load.image("graphics/undraw_Memory_storage_reh0.png")
grid.raster(myimg2)
```
