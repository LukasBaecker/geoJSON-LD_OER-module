...
Think of how we could adjust our the name and type of water properties. You can use this [list of data types](https://www.w3.org/TR/xmlschema-2/#built-in-primitive-datatypes) to find out which data type might be the best fit.
